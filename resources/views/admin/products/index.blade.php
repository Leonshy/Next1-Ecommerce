                    ...
                    <table class="w-full text-xs">
                        ...
                        <tbody class="divide-y divide-blue-100 bg-white">
                            @foreach([
                                ...
                                ['descripcion',       'No', 'Campo legacy, puede dejarse vacío. Reemplazado por los campos abajo',    ''],
                                ['descripcion_corta', 'No', 'Texto breve visible en la ficha junto al precio (máx 250 caracteres)',   'Auriculares inalámbricos con cancelación de ruido'],
                                ['descripcion_larga', 'No', 'Descripción completa con HTML (h2, p, ul, strong, em...) — se muestra al hacer clic en "Ver más"', '<p>Texto <strong>HTML</strong></p>'],
                                ...
                                ['categoria',         'No', 'Nombre exacto de la categoría (se crea automáticamente si no existe)',   'Audio'],
                                ['marca',             'No', 'Nombre exacto de la marca (se crea automáticamente si no existe)',       'Sony'],
                                ...
                                ['oferta',            'No', 'Aparece en sección Ofertas del Día',                                    'true / false'],
                            ] as [$col, $req, $desc, $ej])
